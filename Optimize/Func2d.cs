...
namespace ChacoSharp.Optimize
{
    ...
    {
        private static double s, c;     /* sign and cosine of angle */
        private static double s2, cos2; /* squares of sign and cosine of angle */

        public static double func2d(double[] coeffs, /* five different 4-way products */
...
/* Returns value of penalty function at given angle. */
        ...
        public static double grad2d(double[] coeffs/*[5]*/, /* five different 4-way products */
        double theta      /* angular parameter */
        )
...
/* Returns 1st derivative of penalty function at given angle. */
        ...
        public static double hess2d(double[] coeffs/*[5]*/ /* five different 4-way products */
        )
