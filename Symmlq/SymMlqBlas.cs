...
{
    public static unsafe class SymMlqBlas
    {
        /* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
...
/* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
/* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
private static int chdaxpy(int *n, double *da, double *dx, int *incx, double *dy, int *incy)
{
...
/* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
private static int chdcopy(int *n, double *dx, int *incx, double *dy, int *incy)
{
  /* System generated locals */
  int i__1;
...
/* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
        private static double ch_ddot(int *n, double *dx, int *incx, double *dy, int *incy)
{
  /* System generated locals */
  int i__1;
  double   ret_val;
...
/* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
private static double chdnrm2(int *n, double *dx, int *incx)
{
  /* Initialized data */
